    ...
    for pkg in INTEREST:
        ...
        for version, info in release_info.items():
            for release_artifact in info:
                ...
                # 1.9.0 was a flubbed release.  We removed the tarball and then found we couldn't
                # upload a new version so it ended up being 1.9.0.1
                # I'm not sure why 2.0.0 does not have a tarball but we ended up releasing 2.0.0.0
                # on January 13, 2016 (2.0.0 was created on September 3, 2015)
